...
class PaymentModals extends React.Component {
  ...
  render() {
    return (
      <>
          <Col md="6">
            <li className="text-left btn shadow-none text-white" id="custom-btn" onClick={() => this.toggleModal("defaultModal")}>Payment Methods</li>
            <Modal
          ...
          <Col md="6">
          <h5 className="text-left btn shadow-none text-white" id="custom-btn" onClick={() => this.toggleModal("payOpt")}>Payment Options</h5>
            <Modal
              className="modal-dialog-centered"
              size="lg"
